...
![Formatting status badge](https://github.com/Hochfrequenz/malo-ident-python-models/workflows/Formatting/badge.svg)
...
```bash
uv run --group codegen datamodel-codegen --encoding utf-8 --input openapi/v1/openapi.yml --output src/verzeichnisdienst/v1/_autogenerated.py --input-file-type openapi --output-model-type pydantic_v2.BaseModel --output-datetime-class AwareDatetime
uv run --group codegen ruff format src/verzeichnisdienst/v1/_autogenerated.py
uv run --group codegen ruff check --select I --fix src/verzeichnisdienst/v1/_autogenerated.py
uv run --group codegen datamodel-codegen --encoding utf-8 --input openapi/v1/openapi_websocket.yml --output src/verzeichnisdienst/v1/_autogenerated_websocket.py --input-file-type openapi --output-model-type pydantic_v2.BaseModel --output-datetime-class AwareDatetime
uv run --group codegen ruff format src/verzeichnisdienst/v1/_autogenerated_websocket.py
uv run --group codegen ruff check --select I --fix src/verzeichnisdienst/v1/_autogenerated_websocket.py
```
...
This project uses [uv](https://docs.astral.sh/uv/) for dependency management. After installing uv, set up your development environment with:
