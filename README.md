...
uv run --group codegen black src/verzeichnisdienst/v1/_autogenerated.py
uv run --group codegen isort src/verzeichnisdienst/v1/_autogenerated.py
...
uv run --group codegen black src/verzeichnisdienst/v1/_autogenerated_websocket.py
uv run --group codegen isort src/verzeichnisdienst/v1/_autogenerated_websocket.py
```
