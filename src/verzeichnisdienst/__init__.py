...
# The classes in _autogenerated.py in this sub-package are all autogenerated.
# See the "Project Structure" section in README.md for the regeneration procedure
# (the `uv run --group codegen datamodel-codegen …` steps).
